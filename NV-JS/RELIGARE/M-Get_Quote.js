...
setTimeout(function(){
  ...
  nv_getquotediv.setAttribute("class","got_to_quote");
   nv_getquotediv.innerHTML = '<span class="anim"></span>Get Quote';
            nv_getquotediv.style ="position:fixed;bottom: 50px;cursor: pointer;display: none;z-index: 2;top: 3px; height: 14px; margin-right: 30px; bottom: auto; font-weight: 500; z-index: 99999; width: 95px; padding: 10px; background: linear-gradient(to right, rgb(255, 153, 51) 0%, rgb(255, 51, 0) 100%); border-radius: 0px; right: 15px;font-size: 18px; color: rgb(255, 255, 255); border-bottom: 0px;text-decoration:none;";
...
var nv_Function = function (){
  ...
  if($(document).scrollTop() >= nv_Htotal) {
    $(".got_to_quote").show();
    $(".got_to_quote").css({
      "display":"block","bottom":"auto","top":"3px","z-index":"99998","right":"15px"}
                          );
